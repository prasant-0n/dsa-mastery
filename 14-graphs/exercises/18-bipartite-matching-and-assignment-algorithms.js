...
function hopcroftKarpDFS(state, left) { // TODO
}
function hopcroftKarpMaximumMatching(graph) { // TODO
}
function validateHopcroftKarpState(state) { // TODO
}
function createAssignmentMatrix(rows, cols, defaultCost) { // TODO
}
...
module.exports = {
  ...
  maximumMatchingByBruteForce, normalizeMatching, buildHopcroftKarpState,
  hopcroftKarpBFS, hopcroftKarpDFS, hopcroftKarpMaximumMatching,
  ...
  assignmentToBipartiteGraph, buildAssignmentFlowNetwork, extractAssignmentFromFlow,
  maximumWeightMatching, buildCapacityMatchingNetwork, bMatchingViaFlow,
  hasPerfectMatching, hallWitness, findMinimumVertexCoverFromMatching,
  verifyKonigTheorem, buildMatchingAlternatingGraph, findUnmatchedLeftVertices,
  findMatchedEdges, rerouteMatch, addMatchingEdge, removeMatchingEdge,
  ...
  runDifferentialTests, runPropertyTests, runAdversarialTests, benchmarkKuhn,
  benchmarkHopcroftKarp, benchmarkHungarian, benchmarkBruteForceAssignment,
  benchmarkSparseMatching, benchmarkDenseMatching, benchmarkWeightedMatching,
  benchmarkCapacityMatching, benchmarkMemory, compareKuhnAndHopcroftKarp,
  compareAssignmentAndFlow, analyzeKuhnComplexity, analyzeHopcroftKarpComplexity,
  analyzeHungarianComplexity, analyzeMatchingMemory, designBackendJobAssignment,
  ...
  proveHopcroftKarpCorrectness, proveHallCondition, proveAssignmentFeasibility,
  proveAssignmentOptimality, deriveMatchingComplexity,
  prepareMatchingInterviewExplanation,
};
